...
@Component({
  ...
  styles: [`
    ...
    .log-table th { padding: 8px 10px; background: #111827; color: #6b7280;
                    ...
                    letter-spacing: 0.06em; border-bottom: 1px solid #374151;
                    text-align: left; }
    .log-table tbody tr { border-bottom: 1px solid #1f2937; cursor: pointer;
    ...
    .close-btn { background: none; border: none; color: #6b7280; font-size: 18px;
